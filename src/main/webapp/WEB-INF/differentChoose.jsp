...
<div id="cho">
    ...
    <input type="submit" onclick='location.href=("${pageContext.request.contextPath}/dif/bit")' value="比特型" id="bitDif">



    <input type="submit" onclick='location.href=("${pageContext.request.contextPath}/dif/Truncated")' value="截断型" id="trunckDif">
