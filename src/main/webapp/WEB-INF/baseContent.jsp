...
<head>
    ...
    <script src="${pageContext.request.contextPath}/myJs/jquery-3.2.1.min.js"></script>
</head>
<body bgcolor="#f6f6f6">
...
<div id="beijing">
    ...
    <div id="subfanhui1">
        <input id="sub" type="submit" name="sub" value="返回"
               onclick='location.href=("${pageContext.request.contextPath}/divsionPath")'/>
    </div>
</div>
    ...
    <table id="table">
        <c:forEach items="${fileNameList}" var="list">
            <tr style="height: 30px">
                <th style="height: 30px;width: 240px" align="center" valign="middle">
                        ${list}
                </th>
            </tr>
        </c:forEach>
...
<script type="text/javascript">
    $("#table").on("click", "th", function () {
        ...
        window.location.href="${pageContext.request.contextPath}/getDivsionFile/"+html;
    })
</script>
</body>
</html>