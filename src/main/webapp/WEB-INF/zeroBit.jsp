...
//    System.out.println(request.getSession().getId());
    String html = request.getAttribute("htmlZeroBit") + "";
...
<script>
    ...
    var destination = "channel://<%=ip%>bitZero";
...
<div id="beijing">
    ...
    <table id="tabId">
        <tr id="ziti">
            <div id="wenzi"><font color="#fff" size="5px">比特型零相关线性分析</font></div>
        </tr>
        <tr id="trd">
...
<%
    ...
    String complieRes = request.getSession().getAttribute("tokenResBitZero")+"";
...
<script type="text/javascript">
    $(function () {
        ...
        $("#subbianyi").click(function () {
            ...
            txt = editor.getValue();
            $.post("${pageContext.request.contextPath}/zcBit/submit/text", {subTxt: txt}, function (result) {
                if (result == "编译失败") {
        ...
        $("#fenxi").click(function () {
            ...
            txt = editor.getValue();
            clearShow();
            $.post("${pageContext.request.contextPath}/zcBit/complie", {subTxt: txt}, function (result) {
...
<script type="text/javascript">
    function getDir() {
        ...
        document.write("<form action='${pageContext.request.contextPath}/zcBitPath' method=post name=manageDepForm style='display:none'>");
