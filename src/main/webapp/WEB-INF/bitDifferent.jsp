...
//    System.out.println(request.getSession().getId());
    ...
    String html = request.getSession().getAttribute(userName+"DifBIt") + "";
    System.out.println(html);
...
%>
    ...
    var destination = "channel://<%=userName%>bitDiff";
...
<%
    ...
    String complieRes = request.getSession().getAttribute(userName+"ResDifBIt")+"";
