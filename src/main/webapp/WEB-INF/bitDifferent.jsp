...
<head>
    ...
    <link type="text/css" href="/css/myHIgh.css" rel="stylesheet">
...
<div id="beijing">
    ...
    <table id="tabId" >
        <tr id="ziti" ><div id="wenzi"><font color="#fff" size="6px">比特型差分分析</font></div> </tr>
        <tr id="trd" >
    ...
    <div id="subfanhui">
        <input id="sub" type="submit" name="sub" value="返回" onclick='location.href=("${pageContext.request.contextPath}/choose")'/>
    </div>
</div>
