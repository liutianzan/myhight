...
//    System.out.println(request.getSession().getId());
    String html = request.getAttribute("htmlId") + "";
...
<script>
    ...
    var destination = "channel://<%=ip%>TrunkId";
...
<div id="beijing">
    ...
    <table id="tabId">
        <tr id="ziti">
            <div id="wenzi"><font color="#fff" size="5px">截断型不可能差分分析</font></div>
        </tr>
        <tr id="trd">
...
<%
    ...
    String complieRes = request.getSession().getAttribute("tokenResId")+"";
...
<script type="text/javascript">
    $(function () {
        ...
        $("#subbianyi").click(function () {
            ...
            $.post("${pageContext.request.contextPath}/ibTrunk/submit/text", {subTxt: txt}, function (result) {
                if (result == "编译失败") {
