...
//    System.out.println(request.getSession().getId());
    String html = request.getAttribute("htmlBitId") + "";
    System.out.println(html);
...
<script>
    ...
    var destination = "channel://<%=ip%>BitId";
...
<div id="beijing">
    ...
    <table id="tabId">
        <tr id="ziti">
            <div id="wenzi"><font color="#fff" size="5px">比特型不可能差分分析</font></div>
        </tr>
        <tr id="trd">
...
<%
    ...
    String complieRes = request.getSession().getAttribute("tokenResBitId")+"";
...
<script type="text/javascript">
    $(function () {
        ...
        $("#subbianyi").click(function () {
            ...
            $.post("${pageContext.request.contextPath}/ibBit/submit/text", {subTxt: txt}, function (result) {
                if (result == "编译失败") {
        ...
        $("#fenxi").click(function () {
            ...
            txt = editor.getValue();
            clearShow();
            $.post("${pageContext.request.contextPath}/ibBit/complie", {subTxt: txt}, function (result) {
                if (result == "编译未成功") {
...
<script type="text/javascript">
    function getDir() {
        ...
        document.write("<form action='${pageContext.request.contextPath}/ibBitPath' method=post name=manageDepForm style='display:none'>");
