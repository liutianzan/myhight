...
<div id="cho">
    ...
    <input type="submit" onclick='location.href=("${pageContext.request.contextPath}/zeroBit")' value="比特型" id="bitDif">



    <input type="submit" onclick='location.href=("${pageContext.request.contextPath}/zero")' value="截断型" id="trunckDif">
