...
<script>
    ...
    var destination = "channel://<%=ip%>linearBit";
...
<div id="beijing">
    ...
    <table id="tabId">
        <tr id="ziti">
            <div id="wenzi"><font color="#fff" size="6px">比特型线性分析</font></div>
        </tr>
        <tr id="trd">
...
<%
    ...
    String complieRes = request.getSession().getAttribute("tokenResBitLinear")+"";
...
<script type="text/javascript">
    $(function () {
        ...
        $("#subbianyi").click(function () {
            ...
            $.post("${pageContext.request.contextPath}/linerBit/submit/text", {subTxt: txt}, function (result) {
                if (result == "编译失败") {
        ...
        $("#fenxi").click(function () {
            ...
            txt = editor.getValue();
            clearShow();
            $.post("${pageContext.request.contextPath}/linerBit/complie", {subTxt: txt}, function (result) {
                if (result == "编译未成功") {
...
<script type="text/javascript">
    function getDir() {
        ...
        document.write("<form action='${pageContext.request.contextPath}/linerBitPath' method=post name=manageDepForm style='display:none'>");
    ...
    function getTrace() {
        ...
        txt = editor.getValue();
        compileRes = b.innerHTML;
        document.write("<form action='${pageContext.request.contextPath}/linerBit/trace' method=post name=manageDepForm style='display:none'>");
        document.write("<input type=hidden name='subTxt' value='" + txt + "'/>");//参数1
