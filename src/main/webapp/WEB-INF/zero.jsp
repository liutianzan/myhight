...
//    System.out.println(request.getSession().getId());
    ...
    String html = request.getSession().getAttribute(userName+"TrunkZero") + "";
    System.out.println(html);
...
%>
    ...
    var destination = "channel://<%=userName%>wordZC";
...
<%
    ...
    String complieRes = request.getSession().getAttribute(userName + "ResDifZC") + "";
