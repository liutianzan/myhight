...
//    System.out.println(request.getSession().getId());
    ...
    String html = request.getSession().getAttribute(userName + "divsion") + "";
...
<script>
    ...
    var destination = "channel://<%=userName%>bitDiv";
...
<%
    ...
    String complieRes = request.getSession().getAttribute(userName+"ResDifDiv")+"";
...
<script type="text/javascript">
    $(function () {
        ...
        $("#subbianyi").click(function () {
            ...
            $.post("${pageContext.request.contextPath}/divsion/submit/text", {subTxt: txt}, function (result) {
                if (result == "编译失败") {
        ...
        $("#fenxi").click(function () {
            ...
            txt = editor.getValue();
            clearShow();
            $.post("${pageContext.request.contextPath}/divsion/complie", {subTxt: txt}, function (result) {
                if (result == "编译未成功") {
...
<script type="text/javascript">
    function getDir() {
        ...
        document.write("<form action='${pageContext.request.contextPath}/divsionPath' method=post name=manageDepForm style='display:none'>");
