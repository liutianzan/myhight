...
<div id="beijing">
    ...
    <div id="subfanhui1">
        <input id="sub" type="submit" name="sub" value="返回" onclick='location.href=("${pageContext.request.contextPath}/zeroBit")'/>
    </div>
</div>
...
<script type="application/javascript">
    function reloadView(){
        ...
        $.ajax({
            url:'${pageContext.request.contextPath}/zcBitDir',
            type:'GET',
...
<script type="text/javascript">
    ...
    var LOGIN = {
        ...
        doLogin:function() {
            $.get("/removezcBitSol",function(data){

            });
        },
        login:function() {
            $.get("${pageContext.request.contextPath}/removezcBitSol",function(data){
                if(data=="无可删除文件"){
