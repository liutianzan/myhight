...
<div id="beijing">
    ...
    <div id="subfanhui1">
        <input id="sub" type="submit" name="sub" value="返回" onclick='location.href=("${pageContext.request.contextPath}/linerBit")'/>
    </div>
</div>

<div class= "externalHtml"></div>
<% String txt = request.getAttribute("htmlLinerBit")+"";
...
<script type="application/javascript">
    function reloadView(){
        ...
        $.ajax({
            url:'${pageContext.request.contextPath}/linerBitDir',
            type:'GET',
...
<script type="text/javascript">
    ...
    var LOGIN = {
        ...
        doLogin:function() {
            $.get("/removeLinerBitSol",function(data){

            });
        },
        login:function() {
            $.get("${pageContext.request.contextPath}/removeLinerBitSol",function(data){
                if(data=="无可删除文件"){
