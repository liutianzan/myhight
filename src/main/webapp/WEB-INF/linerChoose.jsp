...
<div id="cho">
    ...
    <input type="submit" onclick='location.href=("${pageContext.request.contextPath}/linerBit")' value="比特型" id="bitDif">



    <input type="submit" onclick='location.href=("${pageContext.request.contextPath}/liner")' value="截断型" id="trunckDif">
